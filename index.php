			...
			<section id="scholars-section" class="page-section hidden">
				...
				<div class="modal-body">
					...
					<div class="modal-section">
						...
						<label id="educationLevelContainer" class="hidden">Education Level
							<select name="education_level" id="educationLevelSelect">
					...
					<div class="modal-section">
						...
						<div class="present-address-fields">
							<div class="form-grid">
								...
								<input type="text" name="present_address" placeholder="Province / City / Barangay / Street" />
								</label>
							</div>
						</div>
					</div>
					...
					<div class="modal-section">
						...
						<!-- School (for all education levels that need it) -->
						<label id="schoolContainer" class="academic-field hidden">School
								<select name="school" id="schoolSelect">
									<option value="">Select School</option>
									<!-- Elementary Schools -->
									<optgroup label="Elementary Schools">
										<option value="Zamboanga City Central Elementary School">Zamboanga City Central Elementary School</option>
										<option value="Tetuan Elementary School">Tetuan Elementary School</option>
										<option value="Tumaga Elementary School">Tumaga Elementary School</option>
										<option value="Baliwasan Elementary School">Baliwasan Elementary School</option>
									</optgroup>
									<!-- High Schools -->
									<optgroup label="High Schools">
										<option value="Zamboanga City High School">Zamboanga City High School</option>
										<option value="Regional Science High School">Regional Science High School</option>
										<option value="Don Pablo Lorenzo Memorial High School">Don Pablo Lorenzo Memorial High School</option>
									</optgroup>
							...
							<!-- School Address (for all education levels that need it) -->
							<label id="schoolAddressContainer" class="academic-field hidden">School Address
								<input name="school_address" type="text" readonly />
							</label>

							<label id="gradeLevelContainer" class="academic-field hidden">Grade Level
								<select name="grade_level" id="gradeLevelSelect">
									<option value="">Select Grade Level</option>
								</select>
							</label>

							<!-- Course (for College only) -->
							<label id="courseContainer" class="academic-field hidden">Course
								<select name="course">
							...
							<label id="strandContainer" class="academic-field hidden">Strand
								<select name="strand">
							...
							<!-- Year Level (for College only) -->
							<label id="yearLevelContainer" class="academic-field hidden">Year Level
							...
							<label id="semesterContainer" class="academic-field hidden">Semester
							...
							<!-- Grading Period (for Elementary, JHS) -->
							<label id="gradingPeriodContainer" class="academic-field hidden">Grading Period
							...
							<div class="detail-card">
								...
								<div class="card-content">
									...
									<div class="address-section">
										<h4 class="address-section-title">Home Address</h4>
										<div class="detail-row">
										...
										<div class="detail-row">
											...
											<span id="scholar-detail-city" class="detail-value">-</span>
										</div>
										<div class="detail-row">
											<span class="detail-label">Barangay:</span>
											<span id="scholar-detail-barangay" class="detail-value">-</span>
										</div>
										<div class="detail-row">
											<span class="detail-label">Street:</span>
											<span id="scholar-detail-street" class="detail-value">-</span>
										</div>
									</div>
									
									<!-- Present Address Section -->
									<div class="address-section">
										<h4 class="address-section-title">Present Address</h4>
										<div class="detail-row">
											<span class="detail-label">Present Address:</span>
											<span id="scholar-detail-present-address" class="detail-value">-</span>
										</div>
									</div>
								</div>
							</div>
